...
export const dummyDashboardData = {
  ...
  topCars: [
    { model: "Toyota Fortuner", revenue: 540 },
    { model: "Mahindra Thar", revenue: 300 },
  ],
  upcomingBookings: [
    { car: "Fortuner", date: "2025-07-03", user: "Pranay Dasari" },
    { car: "Thar", date: "2025-07-05", user: "Kiran Rao" },
  ],
  notifications: [
    "New booking received for Thar",
    "Booking #123 cancelled by user",
  ...
  revenueData: [
    ...
    { month: "May", revenue: 510 },
    { month: "Jun", revenue: 840 },
  ]
};
