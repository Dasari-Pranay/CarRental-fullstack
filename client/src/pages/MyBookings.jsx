...
}, [axios]); // ✅ include axios if it's from context
          ...
          key={booking._id} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border border-borderColor rounded-lg mt-5 first:mt-12'>
            ...
            <div className='md:col-span-2'>
              <div className='flex items-center gap-2'>
                ...
                <p className={`px-3 py-1 text-xs rounded-full flex items-center gap-1 ${getStatusStyles(booking.status)}`}>
                  {booking.status}
            ...
            <div className='md:col-span-1 flex flex-col justify-between gap-6'>
              <div>
                ...
                <p>Booke on {booking.createdAt.split('T')[0]}</p>
              </div>
            </div>
          </motion.div>
        ))}
